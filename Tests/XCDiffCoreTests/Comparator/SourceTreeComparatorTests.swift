...
final class SourceTreeComparatorTests: XCTestCase {
    private var subject: SourceTreeComparator!

    override func setUp() {
        subject = SourceTreeComparator()
    }
    ...
    func testTag() {
        // When / Then
        XCTAssertEqual(subject.tag, "source_tree")
    }
